...
def tobs():
    ...
    # most_recent_date returns('2017-08-23'). This date will be used to create a date time object to find start query date 
    ...
    for date in most_recent_date:
        most_recent_date_dict = {}
        most_recent_date_dict["date"] = date
        most_recent_values.append(most_recent_date_dict) 
    ...
    # query_start_date returns ('2016-08-23') 
